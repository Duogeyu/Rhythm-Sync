...
function stringSimilarity(a, b) {
    ...
    // Jaccard on bigrams
    // ⚡ Bolt: Replaced .substring(i, i+2) with bitwise packing of character codes
    // Impact: Avoids allocating temporary string objects, eliminating GC overhead in hot loops
    const bigrams = (s) => {
        const set = new Set();
