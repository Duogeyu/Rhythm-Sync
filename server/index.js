...
function stringSimilarity(a, b) {
    ...
    const bigrams = (s) => {
        const set = new Set();
        // ⚡ Bolt Optimization: Use bitwise packing of character codes instead of string segmentation
        // This avoids creating temporary string objects and eliminates garbage collection overhead in hot loops
