...
function stringSimilarity(a, b) {
    ...
    const bigrams = (s) => {
        const set = new Set();
        // Optimize memory-intensive string operations:
        // Use bitwise packing of character codes to avoid creating short-lived string objects.
        // This eliminates garbage collection overhead in hot loops.
