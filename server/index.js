...
function stringSimilarity(a, b) {
    ...
    // Jaccard on bigrams
    // ⚡ Bolt: Optimized by replacing string substring with bitwise packing of char codes.
    // This avoids creating temporary short string objects and drastically reduces GC overhead in hot loops.
    const bigrams = (s) => {
        const set = new Set();
